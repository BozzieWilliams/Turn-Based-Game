(() => {
    ...
    const positionRequiredToStartTheFight = (row, column) => {
        if ((row > 0 && gridElement.arrangement[row - 1][column].player == true) ||
            (row < 9 && gridElement.arrangement[row + 1][column].player == true) ||
            (column > 0 && gridElement.arrangement[row][column - 1].player == true) ||
            (column < 9 && gridElement.arrangement[row][column + 1].player == true)) {
